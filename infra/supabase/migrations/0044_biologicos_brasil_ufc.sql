...
BEGIN
  ...
  --    technical_specs é SUBSTITUÍDO (não merge) para remover strains/application_modes legados.
  UPDATE products SET
    ...
    technical_specs = '{"physical_state":"fluido","origin_country":"Brasil","product_type":"Complexo microbiológico","concentration_total":"5,0 × 10⁹ UFC/mL"}'::jsonb,
    updated_at = now()
